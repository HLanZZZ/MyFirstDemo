...
//	PRICES_NOT_AVAILABLE(403,"AES_PP_E009","Unavailable seats exists in the cart","Some of the product items in the cart is not available anymore, please remove them and retry"),
	...
	AYMENT_EMD_EXIST(403,"AES_BO_E013","EMD attached with a seat","The seat is attached with a EMD, system unable to exchange it with a extra long leg room seat"),
	...
	//ancillaryBooking products
	RLOC_MISSING(400,"AESSS_ERR_E003","Unable to connect with 1A","Rloc missing"),
	PRODUCT_TYPE_SEAT(403,"AESSS_ERR_E003","Unable to connect with 1A","ProductType should be seat"),
	RLOC_NOT_EXIST(403,"AESSS_ERR_E001","Can not query DB","Check if this rloc exists in the db"),
	MORE_THAN_1_RECORDS(403,"AESSS_ERR_E004","Unable to get message","Booking more than 1 records returned"),
	...
	COMMON_DB_NO_CONNECTION(403,"AESSS_ERR_E002","Unable to connect to the database",""),
	COMMON_CONNECTION_TIMEOUT(403,"AESSS_ERR_E002","Datastore connection timeout","The connection to the AESSS datastore time-out");
